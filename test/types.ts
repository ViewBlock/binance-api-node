...
test('types should compile correctly', async t => {
  ...
  const universalTransfer = client.universalTransfer({ type: 'MAIN_UMFUTURE', asset: 'BTC', amount: '1' })
  ...
  const futuresMarkPriceCandles = client.futuresMarkPriceCandles({ symbol: 'BTCUSDT', interval: '1m' })
  const futuresIndexPriceCandles = client.futuresIndexPriceCandles({ pair: 'BTCUSDT', interval: '1m' })
  ...
  const futuresOrder = client.futuresOrder({ symbol: 'BTCUSDT', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' })
  const futuresBatchOrders = client.futuresBatchOrders({ batchOrders: [{ symbol: 'BTCUSDT', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' }] })
  ...
  const futuresCancelBatchOrders = client.futuresCancelBatchOrders({ symbol: 'BTCUSDT', orderIdList: [12345] })
  ...
  const futuresPositionMargin = client.futuresPositionMargin({ symbol: 'BTCUSDT', positionSide: 'BOTH', amount: '1', type: 1 })
  ...
  const deliveryMarkPriceCandles = client.deliveryMarkPriceCandles({ symbol: 'BTCUSD_PERP', interval: '1m' })
  const deliveryIndexPriceCandles = client.deliveryIndexPriceCandles({ pair: 'BTCUSD', interval: '1m' })
  ...
  const deliveryOrder = client.deliveryOrder({ symbol: 'BTCUSD_PERP', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' })
  const deliveryBatchOrders = client.deliveryBatchOrders({ batchOrders: [{ symbol: 'BTCUSD_PERP', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' }] })
  ...
  const deliveryCancelBatchOrders = client.deliveryCancelBatchOrders({ symbol: 'BTCUSD_PERP', orderIdList: [12345] })
  ...
  const deliveryMarginType = client.deliveryMarginType({ symbol: 'BTCUSD_PERP', marginType: 'ISOLATED' })
  const deliveryPositionMargin = client.deliveryPositionMargin({ symbol: 'BTCUSD_PERP', positionSide: 'BOTH', amount: '1', type: 1 })
  ...
  const papiUmOrder = client.papiUmOrder({ symbol: 'BTCUSDT', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' })
  const papiUmConditionalOrder = client.papiUmConditionalOrder({ symbol: 'BTCUSDT', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000', stopPrice: '51000' })
  const papiCmOrder = client.papiCmOrder({ symbol: 'BTCUSD_PERP', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' })
  const papiCmConditionalOrder = client.papiCmConditionalOrder({ symbol: 'BTCUSD_PERP', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000', stopPrice: '51000' })
  const papiMarginOrder = client.papiMarginOrder({ symbol: 'BTCUSDT', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' })
  const papiMarginLoan = client.papiMarginLoan({ asset: 'BTC', amount: '1' })
  const papiRepayLoan = client.papiRepayLoan({ asset: 'BTC', amount: '1' })
  const papiMarginOrderOco = client.papiMarginOrderOco({ symbol: 'BTCUSDT', side: OrderSide.BUY, quantity: '1', price: '50000', stopPrice: '51000' })
  ...
  const papiUmCancelConditionalOrder = client.papiUmCancelConditionalOrder({ symbol: 'BTCUSDT', orderId: 12345 })
  const papiUmCancelConditionalAllOpenOrders = client.papiUmCancelConditionalAllOpenOrders({ symbol: 'BTCUSDT' })
  ...
  const papiCmCancelConditionalOrder = client.papiCmCancelConditionalOrder({ symbol: 'BTCUSD_PERP', orderId: 12345 })
  const papiCmCancelConditionalAllOpenOrders = client.papiCmCancelConditionalAllOpenOrders({ symbol: 'BTCUSD_PERP' })

  // Test margin endpoints
  const marginOrder = client.marginOrder({ symbol: 'BTCUSDT', side: OrderSide.BUY, type: OrderType.LIMIT, quantity: '1', price: '50000' })
  const marginOrderOco = client.marginOrderOco({ symbol: 'BTCUSDT', side: OrderSide.BUY, quantity: '1', price: '50000', stopPrice: '51000' })
  ...
  const marginIsolatedTransfer = client.marginIsolatedTransfer({ asset: 'BTC', symbol: 'BTCUSDT', transFrom: 'SPOT', transTo: 'ISOLATED_MARGIN', amount: '1' })
  ...
  const miningHashrateResaleRequest = client.miningHashrateResaleRequest({ userName: 'user', coinName: 'BTC', algo: 'sha256', startDate: 1234567890, endDate: 1234567890, pageIndex: 1, pageSize: 10 })
  const miningHashrateResaleCancel = client.miningHashrateResaleCancel({ configId: 123, userName: 'user' })
