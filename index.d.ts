...
declare module 'binance-api-node' {
	...
	export interface WebSocket {
		...
		futuresUser: (
			callback: (msg: OutboundAccountInfo | ExecutionReport | AccountUpdate | OrderUpdate | AccountConfigUpdate | MarginCall) => void,
		) => Promise<ReconnectingWebSocketHandler>
	}
	...
	export type EventType_LT = 'account' | 'balanceUpdate' | 'outboundAccountPosition'
		| 'executionReport' | 'ACCOUNT_UPDATE' | 'MARGIN_CALL' | 'ACCOUNT_CONFIG_UPDATE'
